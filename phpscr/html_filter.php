 ...
 */
class html_filter {
	var $tagsArray = array('b', 'a', 'br', 'div', 'img', 'h1');			// default = empty array
	var $attrArray = array('style', 'href', 'src');				// default = empty array
	 ...
	 */
	function html_filter($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1) {
	...
	function process($source) {
		...
		$conf['doctype']="auto";
		$source=tidy_repair_string($source, $conf, "utf8");
		if (is_array($source)) {
